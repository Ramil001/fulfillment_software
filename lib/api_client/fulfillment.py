...
class FulfillmentAPI:
    ...
    def list(self, filters: dict = None):
        ...
        url = f"https://{self.client.api_domain}/api/v1/fulfillments"
    ...
    def get(self, fulfillment_id: str):
        ...
        url = f"https://{self.client.api_domain}/api/v1/fulfillments/{fulfillment_id}"
    ...
    def set_webhook(self, fulfillment_id: str, url_param: str):
        """Задать вебхук"""
        url = f"https://{self.client.api_domain}/api/v1/fulfillments/{fulfillment_id}/webhook"
    ...
    def get_transfers_by_fulfillment(self, fulfillment_id, params=None):
        url = f"https://{self.client.api_domain}/api/v1/fulfillments/{fulfillment_id}/transfers"
